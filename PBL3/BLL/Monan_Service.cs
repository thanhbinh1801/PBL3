    ...
    public class MonAn_Service
    {
        ...
        public MonAnNguyenLieu GetMonAnNguyenLieuByNameMonAnandNL(string tenMonAn, string tenNguyenLieu)
        {
            try
            {
                ...
                if (monAn != null)
                {
                    var nguyenLieu = db.nguyenLieu.FirstOrDefault(nl => nl.tenNguyenLieu == tenNguyenLieu);
                    if (nguyenLieu != null)
                    {
                        var monAnNguyenLieu = db.MonAnNguyenLieux
                                                .Where(mnl => mnl.IDMonAn == monAn.IDMonAn && mnl.IDNguyenLieu == nguyenLieu.IDNguyenLieu)
                                                .SingleOrDefault(); 
        ...
        public bool UpdateMonAnNguyenLieu(MonAnNguyenLieu monAnNguyenLieu)
        {
            try
            {
                ...
                var existingRecord = db.MonAnNguyenLieux
                                        .FirstOrDefault(mnl => mnl.IDMonAn == monAnNguyenLieu.IDMonAn && mnl.IDNguyenLieu == monAnNguyenLieu.IDNguyenLieu);
